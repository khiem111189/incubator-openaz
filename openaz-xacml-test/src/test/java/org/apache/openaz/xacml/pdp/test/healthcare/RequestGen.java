...
public class RequestGen {
	public static void main(String[] args) throws Exception {
		...
		FileUtils.write(new File("E:\\Workspace\\Thesis\\openaz-work\\openaz-xacml-test\\src\\test\\resources\\testsets\\healthcare\\requests\\Request." + 1 + ".Permit.json"), JSONRequest.toString(RequestParser.parseRequest(req)));
	}
